import BestSellersRankTrend from '@/components/UI/BestSellerRank'
import ProfitAndLoss from '@/components/UI/ProfitAndLoss'
import ProfitLossProjection from '@/components/UI/ProfitAndLossProjection'
import AdsCostComparison from '@/components/UI/YearComparison'
...
export default async function HomePage() {
  ...
  return (
    <div className="flex flex-col items-start justify-center gap-8">
      ...
      <AdsCostComparison data={salesData} />
      <BestSellersRankTrend data={salesData} />
      <ProfitLossProjection data={salesData} />
    </div>
  )
}
